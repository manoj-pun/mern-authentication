...
const Header = () => {
  ...
  return (
    <div className='flex flex-col items-center mt-20 px-4 text-center text-gray-800'>
      ...
      <h1 className='flex items-center gap-2 text-xl sm:text-3xl font-medium mb-2'>Hey {userData ? userData.name.toUpperCase() : "Developer"}! <img className='w-8 aspect-square' src={assets.hand_wave} alt="" /></h1>
